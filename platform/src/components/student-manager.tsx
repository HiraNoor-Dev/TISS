...
const guardianBody = (form: FormData) => ({ fullName: form.get('fullName'), phone: form.get('phone'), whatsapp: form.get('whatsapp') ?? '', relationship: form.get('relationship'), isPrimary: form.get('isPrimary') === 'on' });
